...
dataset
'''
filename_checkpoint = '../ckpt/model_01.ckpt'
list_dataset_test =  [
				{
				 'input':'/research/data/aj/data_lowdoseCT/trial03/DRF100_nifti/803_.nii.gz',
				 'gt':'/research/data/aj/data_lowdoseCT/trial03/DRF001_nifti/800_.nii.gz'
				},
				{
				 'input':'/research/data/aj/data_lowdoseCT/trial04/DRF100_nifti/803_.nii.gz',
				 'gt':'/research/data/aj/data_lowdoseCT/trial04/DRF001_nifti/800_.nii.gz'
				}
				]
